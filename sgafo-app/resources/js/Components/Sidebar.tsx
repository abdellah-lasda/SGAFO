            ...
            <nav className="flex-1 overflow-y-auto px-4 space-y-8 scrollbar-hide pb-10">
                ...
                <div>
                    ...
                    <div className="space-y-1.5">
                        ...
                        {(isCDC || isRF || isAdmin) && (
                            <Link
                                href={route('modules.logistique.index')}
                                className={`flex items-center px-4 py-2.5 text-sm font-bold rounded-xl transition-colors ${route().current('modules.logistique.*') ? activeClass : inactiveClass}`}
                            >
                                <svg className="mr-3 h-5 w-5 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
