    ...
    return (
        <aside className="w-64 bg-[#0f172a] text-white flex flex-col h-full shadow-2xl font-sans border-r border-slate-800/50">
            ...
            <nav className="flex-1 overflow-y-auto px-4 space-y-8 scrollbar-hide pb-10">
                ...
                {(isCDC || isRF) && (
                    <div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <Link
                                href={route('modules.absences.dashboard')}
                                className={`flex items-center px-4 py-2.5 text-sm font-bold rounded-xl transition-colors ${route().current('modules.absences.dashboard') ? activeClass : inactiveClass}`}
                            >
                                <svg className="mr-3 h-5 w-5 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {isFormateur && (
                    <div>
                        <h3 className="px-4 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-4">Animateur</h3>
                        <div className="space-y-1.5">
                            <Link
                                href={route('modules.animateur.dashboard')}
                                className={`flex items-center px-4 py-2.5 text-sm font-bold rounded-xl transition-colors ${route().current('modules.animateur.dashboard') ? activeClass : inactiveClass}`}
                            >
                                <svg className="mr-3 h-5 w-5 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <Link
                                ...
                                className={`flex items-center px-4 py-2.5 text-sm font-bold rounded-xl transition-colors ${route().current('modules.animateur.formations') ? activeClass : inactiveClass}`}
                            >
                                <svg className="mr-3 h-5 w-5 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                </svg>
                ...
                {isFormateur &&(<div>
                    ...
                    <div className="space-y-1.5">
                        <Link
                            ...
                            className={`flex items-center px-4 py-2.5 text-sm font-bold rounded-xl transition-colors ${route().current('participant.dashboard') ? activeClass : inactiveClass}`}
                        >
                            <svg className="mr-3 h-5 w-5 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                        ...
                        <Link
                            ...
                            className={`flex items-center px-4 py-2.5 text-sm font-bold rounded-xl transition-colors ${route().current('participant.formations') ? activeClass : inactiveClass}`}
                        >
                            <svg className="mr-3 h-5 w-5 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                            </svg>
                ...
                {isDR && (
                    <div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <Link
                                href={route('dr.documents.index')}
                                className={`flex items-center px-4 py-2.5 text-sm font-bold rounded-xl transition-colors ${route().current('dr.documents.*') ? activeClass : inactiveClass}`}
                            >
                                <svg className="mr-3 h-5 w-5 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
