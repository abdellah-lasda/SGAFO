                            ...
                            <tbody className="divide-y divide-slate-100">
                                {users.data.map((user: any) => (
                                    <tr key={user.id} className="hover:bg-slate-50/50 transition-colors group">
                                        ...
                                        <td className="px-8 py-5 text-right space-x-2 flex items-center">
                                            <Link href={route('admin.users.dossier', user.id)} className="p-2 text-slate-400 hover:text-blue-600 transition-colors inline-block" title="Voir le dossier consolidé">
