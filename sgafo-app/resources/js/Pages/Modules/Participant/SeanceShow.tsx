            ...
            <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-8">
                        ...
                        {hasFeedbackForm && (
                            <div className="bg-emerald-50 border border-emerald-100 rounded-[2.5rem] p-8 text-emerald-900 shadow-sm relative overflow-hidden">
                                ...
                                {hasSubmittedFeedback ? (
                                    ...
                                    <Link
                                        href={route('participant.feedback.show', seance.id)}
                                        className="w-full inline-block py-4 bg-emerald-500 text-white rounded-2xl text-[11px] font-black uppercase tracking-widest text-center hover:bg-emerald-600 transition-all shadow-lg active:scale-95"
                                    >
                                        Évaluer maintenant
                                    </Link>
                                )}
